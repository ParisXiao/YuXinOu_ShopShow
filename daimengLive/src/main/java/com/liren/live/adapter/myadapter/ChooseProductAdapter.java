...
public class ChooseProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public ChooseProductAdapter(Context context, List<String> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View itemView = mInflater.inflate(R.layout.item_chooseseller, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView sellerName;
        @BindView(R.id.seller_choose)
        ImageView sellerChoose;
        @BindView(R.id.jianshu)
        TextView jianshu;
        @BindView(R.id.seller_num)
        TextView sellerNum;
        @BindView(R.id.seller_sp1)
        ImageView sellerSp1;
        @BindView(R.id.seller_sp2)
        ImageView sellerSp2;
        @BindView(R.id.seller_sp3)
        ImageView sellerSp3;
        @BindView(R.id.seller_sp_num)
        TextView sellerSpNum;
        public MyViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
            itemView.setOnClickListener(ChooseProductAdapter.this);
        }
