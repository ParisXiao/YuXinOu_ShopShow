...
public class TeachFragment extends MyBaseFragment {
    @BindView(R.id.web_teach)
    WebView webTeach;
    Unbinder unbinder;
...
// TODO Auto-generated method stub
    ...
    protected void initView(View view) {
        WebSettings webSettings = webTeach.getSettings();
...
//         mWebView.addJavascriptInterface(new JsInteration(), "android");
        webTeach.setWebViewClient(new WebViewClient());
        webTeach.setWebChromeClient(new WebChromeClient());
        webTeach.loadUrl(HtmlConfig.TEACH);
        ...
        webTeach.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (!url.equals(HtmlConfig.TEACH)){
