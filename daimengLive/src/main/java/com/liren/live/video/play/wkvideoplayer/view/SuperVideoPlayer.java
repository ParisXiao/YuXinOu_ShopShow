...
package com.liren.live.video.play.wkvideoplayer.view;
...
import com.liren.live.video.play.TXPlayerAuthParam;
...
//        authBuilder.setSign("d6581029cb5fbe44f938b1b4fadbb0dc");
    ...
    private void stopListen() {
        ...
        AppContext.getInstance().unregisterActivityLifecycleCallbacks(mPhoneListener);
    }
    ...
    private void startListen() {
        ...
        AppContext.getInstance().registerActivityLifecycleCallbacks(mPhoneListener);
    }
