...
//主页面
public class CommonLiveActivity extends MyBaseActivity implements
        ...
        for (int i = 0; i < size; i++) {
            ...
            tab.setContent(new TabHost.TabContentFactory() {
                ...
                public View createTabContent(String tag) {
                    return new View(CommonLiveActivity.this);
                }
            });
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                if(res != null){
                    try {
                        ...
                        SharedPreUtil.put(CommonLiveActivity.this,"config_temp",res.getString(0));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void showSelectLiveTypeDialog() {
        ...
        UIHelper.showRtmpPushActivity(CommonLiveActivity.this,0);
