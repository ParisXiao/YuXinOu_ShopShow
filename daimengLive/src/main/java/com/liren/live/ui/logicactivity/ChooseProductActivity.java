    ...
    private void initLoad() {
        ...
        myEmpty.setOnButtonClick(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myEmpty.showLoading(ChooseProductActivity.this);
                //重新加载数据
                getData();
            }
        });
    ...
    private void getData() {
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (OKHttpUtils.isConllection(ChooseProductActivity.this)) {
...
//                        String token = PreferenceUtils.getInstance(getActivity()).getString(UserConfig.DToken);
                    ...
                    String result = OKHttpUtils.postData(ChooseProductActivity.this, UrlConfig.MemberPushSupplier, token, key, map);
