...
public class MyVoiceActivity  extends MyBaseActivity {
    ...
    protected void initData() {
        list = new ArrayList<>();
        initLoad();
        recycler.setLayoutManager( new GridLayoutManager(MyVoiceActivity.this, 2, GridLayoutManager.VERTICAL, false));
        recycler.addItemDecoration(new GridSpacingItemDecoration(2,20,true));
        recycler.setAdapter(adapter = new VideoListAdapter(MyVoiceActivity.this, list));
...
//                    跳转
                    ...
                    Intent intent=new Intent(MyVoiceActivity.this, VoiceActivity.class);
    ...
    private void getData(final List<VideoListEntity> list) {
        ...
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (OKHttpUtils.isConllection(MyVoiceActivity.this)) {
                    String[] key = new String[]{"pageindex", "pagerows"};
                    Map<String, String> map = new HashMap<String, String>();
                    map.put("platform",  "APP");
                    map.put("token", AppContext.getInstance().getToken());
                    map.put("pageindex", pageindex+"");
                    map.put("pagerows", "10");
                    map.put("pagesortfield", "");
                    map.put("pagesorttype", "");
//                        String token = PreferenceUtils.getInstance(getActivity()).getString(UserConfig.DToken);
                    String token = AppContext.getInstance().getToken();
                    String result = OKHttpUtils.postData(MyVoiceActivity.this, UrlConfig.SmallVideoInfoSelectVideo, token, key, map);
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 == adapter.getItemCount()) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            //设置回到上拉加载更多
                            Toast.makeText(MyVoiceActivity.this, "更新了 " + list.size() + " 条数据", Toast.LENGTH_SHORT).show();
                            adapter.changeMoreStatus(adapter.NO_LOAD_MORE);
                        }
                    }, 1000);
