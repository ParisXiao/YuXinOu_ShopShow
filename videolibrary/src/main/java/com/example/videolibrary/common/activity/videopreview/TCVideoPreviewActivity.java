package com.example.videolibrary.common.activity.videopreview;
...
import com.example.videolibrary.videoupload.TXUGCPublish;
import com.example.videolibrary.videoupload.TXUGCPublishTypeDef;
...
public class TCVideoPreviewActivity extends Activity implements View.OnClickListener, ITXLivePlayListener {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.video_publish) {
            publish();

        } else if (i == R.id.record_to_edit) {
            startEditVideo();
