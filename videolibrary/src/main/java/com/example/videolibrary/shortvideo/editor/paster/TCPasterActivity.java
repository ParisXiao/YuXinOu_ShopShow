...
import com.example.videolibrary.shortvideo.editor.paster.view.PasterAdapter;
import com.example.videolibrary.shortvideo.editor.paster.view.PasterOperationView;
import com.example.videolibrary.shortvideo.editor.paster.view.TCPasterOperationViewFactory;
import com.example.videolibrary.shortvideo.editor.paster.view.TCPasterSelectView;
...
//        mVideoProgressView.setViewHeight(getResources().getDimensionPixelOffset(R.dimen.video_progress_height));
...
//            case R.id.paster_fl_player:
//                if (mTCPasterSelectView.getVisibility() == View.VISIBLE) {
